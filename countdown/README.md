...
1. Open `index.html` in any browser (double-click it, or drag it into a browser tab).
2. **Every morning**, hit **"I showed up today ✓"**. That's it.
3. Watch your **streak** grow and the **countdown** shrink.

That's the whole ritual. Show up, mark the day, keep your streak alive.

## What's inside

- ⏳ **Live countdown** to Sept 1, 2026 (days, hours, minutes, seconds).
- 📊 **Progress bar** showing how far along the journey you are.
- 🔥 **Daily check-in** with current streak, total days, and best streak.
- 💬 A **rotating daily reminder** to keep your head right.
- 🎯 Your **why** — the vision, written down where you'll see it.
- 🗓️ A **journey grid** — one square per day, filled in when you show up.
